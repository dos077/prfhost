<template>
  <div style="grid-column: span 2;">
    <v-content v-if="!user && user !== undefined">
      <section>
        <v-container>
          <v-row class="py-4">
            <v-col :cols="lgCols" class="text-block">
              ...
              <p>
                ...
                <v-btn
                  class="ttl"
                  text
                  href="https://github.com/dos077/prfhost"
                >
                  Github
                </v-btn>
              </p>
        ...
        <v-container>
          <v-row>
            ...
            <v-col :cols="smCols" class="text-block">
              ...
              <p>
                <v-btn class="ttl" href="https://github.com/dos077/prfhost">
                  github repo
                </v-btn>
              </p>
            </v-col>
...
export default {
  ...
  watch: {
    user: {
      handler(to) {
        if (to) this.$router.push({ path: '/account' })
      },
      immediate: true
    }
  }
